...
def test_jet_creation_makino(makino_env):
    ...
    M_x = 25
    Q = 1e37 * u.W
    test_jet = jet.AstroJet(theta_deg, M_x, makino_env.sound_speed,
...
def test_jet_creation_king(king_env):
    ...
    M_x = 25
    Q = 1e37 * u.W
    test_jet = jet.AstroJet(theta_deg, M_x, king_env.sound_speed,
                            king_env.central_density, Q, king_env.gamma)
