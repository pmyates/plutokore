...
class ploadparticles(object):
    ...
    def GetParticleData(self):
        ...
        A = _np.array_split(data_, [self.tot_fdim*i for i in range(1,np_)])
        
        tup_ = []
        arr_ = _np.zeros([np_, len(vars_)])
        ...
        try:
            ...
            nflx_ = fdims[scrh]
            shkvL_ = _np.zeros((np_, nflx_))
            shkvR_ = _np.zeros((np_, nflx_))
        ...
        try:
            ...
            nebins_ = fdims[scrh]
            eng_ = _np.zeros((np_,nebins_))
            chi_ = _np.zeros((np_,nebins_))
